...
public final class PulsarTransactionUtils {
	 ...
	 * @param pulsarClient the client used to obtain the transaction resource
	 * @param timeoutSeconds the max seconds for the transaction to be completed before it
